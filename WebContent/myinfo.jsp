...
/* container */
#header { width: 100%; padding: 10px 0; background: #4082ed; text-align: center; color: #fff; }
...
#sidebar_left { left: 0; background:skyblue}
#sidebar_right { right: 0;background:skyblue}
